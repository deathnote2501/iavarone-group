      ...
      <div className="flex flex-col gap-6 rounded-2xl border border-[var(--color-line)] bg-white p-6 sm:flex-row sm:items-start sm:p-8">
        ...
        <div className="min-w-0">
          ...
          <h2 className="mt-1 text-lg font-semibold">
            <Link href="/a-propos" className="hover:text-[var(--color-brand-blue-ink)]">
              {SITE.founder.name}
            </Link>
          </h2>
          <p className="text-sm text-[var(--color-brand-blue-ink)]">{SITE.founder.role}</p>
          ...
          <div className="mt-5 flex flex-wrap items-center gap-4 text-sm">
            <Link href="/a-propos" className="inline-flex items-center gap-1 font-medium text-[var(--color-brand-blue-ink)] hover:underline">
              Parcours complet
